  ...
  <div>
    ...
    <span class="inline-flex shadow-sm rounded-md">
      <g-link
        ...
        class="inline-flex items-center px-6 py-2 text-sm font-medium border version-btn border-ui-border focus:z-10 focus:outline-none focus:border focus:border-ui-primary focus:border-ui-primary"
      >
        {{ version.name }}
      </g-link>
    </span>
